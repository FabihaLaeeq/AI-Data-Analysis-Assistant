...
👉 https://ai-data-analysis-assistant-1.streamlit.app/

You can upload a CSV dataset and interact with the application directly through the browser.
...
git clone https://github.com/FabihaLaeeq/AI-Data-Analysis-Assistant.git
